  ...
  if (meetings.length === 0) {
    tableContainer.innerHTML = `
      <div style="padding:60px 40px;text-align:center;background:linear-gradient(135deg,var(--gray-50) 0%,white 100%);">
        ...
        <div style="font-size:14px;color:var(--gray-500);margin-bottom:24px;">Start by adding an event</div>
          <button class="btn btn-primary" onclick="openMeetingForm()" style="padding:10px 24px;border-radius:8px;">+ Add Event</button>
      </div>
    `
    return
  }
...
function clearMeetingForm() {
  document.getElementById('meetingFormTitle').textContent = 'Add New Event'
