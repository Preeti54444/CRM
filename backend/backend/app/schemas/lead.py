...
class ExistingLeadInfo(BaseModel):
    """Information about an existing lead (returned in duplicate responses)."""
    id: int
    lead_name: str
...
class DuplicateCheckResponse(BaseModel):
    """Response when a duplicate lead is detected."""
    duplicate: bool
    type: str  # hard_duplicate or potential_duplicate
    message: str
