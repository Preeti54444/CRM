...
# ═══ LEAD TAKEOVER REQUEST SCHEMAS ═══
class LeadTakeoverRequestBase(BaseModel):
    lead_id: int
    request_reason: Optional[str] = None
    reason: Optional[str] = None


class LeadTakeoverRequestCreate(LeadTakeoverRequestBase):
    pass


class LeadTakeoverRequestResponse(LeadTakeoverRequestBase):
    id: int
    status: str
    request_reason: Optional[str] = None
...
# ═══ LEAD INTERESTED REQUEST SCHEMAS ═══
class LeadInterestedRequestBase(BaseModel):
    lead_id: int
    request_reason: Optional[str] = None
    reason: Optional[str] = None


class LeadInterestedRequestCreate(LeadInterestedRequestBase):
    pass


class LeadInterestedRequestResponse(LeadInterestedRequestBase):
    id: int
    status: str
    request_reason: Optional[str] = None
    review_comment: Optional[str] = None
