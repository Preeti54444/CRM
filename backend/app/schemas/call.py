...
class CallBase(BaseModel):
    ...
    sale_executive: Optional[constr(strip_whitespace=True, max_length=255)] = None
    product: Optional[constr(strip_whitespace=True, max_length=255)] = None
    source: Optional[constr(strip_whitespace=True, max_length=255)] = None
    customer_company_name: Optional[constr(strip_whitespace=True, max_length=255)] = None
    contact_person_name: Optional[constr(strip_whitespace=True, max_length=255)] = None
