...
from sqlalchemy import Column, Date, DateTime, Date, ForeignKey, Integer, String, Time, Boolean
...
class Target(Base):
    ...
    # New fields for admin target assignment tracking
    assigned_by = Column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=True)
    assigned_at = Column(DateTime, nullable=True)
    notification_sent = Column(Boolean, default=False)
    
    # Relationship to the admin who assigned the target
