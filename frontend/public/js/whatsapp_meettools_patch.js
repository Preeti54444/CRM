    ...
    <div>
      ...
      <div class="mt-card" style="margin-bottom:20px;">
        <div class="mt-card-hd">
          ...
          <div><h3>Generate Event Link</h3><p>Create a Google Meet or Zoom link for an event</p></div>
        </div>
        ...
        <div class="mt-platform-tabs">
          ...
          <div class="mt-field"><label>Event Title</label><input type="text" id="mtTitle" placeholder="e.g. Funding Sathi – Product Demo"></div>
