...
def create_task_endpoint(
    ...
    # broadcast a serializable representation (use Pydantic model from ORM)
    background_tasks.add_task(
...
def update_task_endpoint(
    ...
    background_tasks.add_task(
        ...
        'task',
        'update',
        TaskResponse.from_orm(updated_task).dict()
    )
...
def delete_task_endpoint(
    ...
    task = get_task_by_id(db, task_id)
    if task is None:
        # Idempotent: return success if task is already deleted
